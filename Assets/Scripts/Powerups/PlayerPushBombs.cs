...
public class PlayerPushBombs: MonoBehaviour
{
    private PlayerController playerController;

    public AudioSource pushPickUp;
    ...
    {
        //Set player powerup to playerPushBombs. Logic will be in the player controller script
        playerController.playerPowerup = PlayerPowerup.playerPushBombs;
        Debug.Log("Push Bomb Power up picked up by Player " + playerID);
