...
public class PierceBomb : MonoBehaviour
{
    private PlayerController playerController;

    public AudioSource piercePickUp;
    ...
    void PickUp(int playerID)
    {
        ...
        playerController.playerBombType = BombTypes.PierceBomb;
        Debug.Log("Pierce Bomb Power up picked up by Player " + playerID);
