...
public class RemoteBomb : MonoBehaviour
{
    ...
    public AudioSource remotePickUp;
    ...
    {
        //Set player bombType to Pierce Bomb. Pierce bomb logic will be in the bomb behavior script
        playerController.playerBombType = BombTypes.RemoteBomb;
        Debug.Log("Remote Bomb Power up picked up by Player " + playerID);
        ...
        GetComponent<PowerupJumper>()?.HoverCleanUp();
        //Destroy(gameObject);
    }
