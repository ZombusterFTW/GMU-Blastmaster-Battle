...
public class PlayerFly: MonoBehaviour
{
    ...
    {
        //Set player powerup to playerFly. Logic will be in the player controller script
        playerController.playerPowerup = PlayerPowerup.playerFly;
        Debug.Log("Flying Power up picked up by Player " + playerID);
